                    ...
                    if (index.equals("사칙")) {
                        ...
                        while (true) {
                            ...
                            if ( calculator.setCheck()) {
                                if (operate=='+'){
                                    System.out.println("결과: " + calculator.addOperator.setResult(fristnumber,secondnumber));
                                    calculator.setAddList();
                                } else if (operate=='-'){
                                    System.out.println("결과: " + calculator.subtractOperator.setResult(fristnumber,secondnumber));
                                    calculator.setAddList();
                                } else if (operate=='*'){
                                    System.out.println("결과: " + calculator.multiplyOperator.setResult(fristnumber,secondnumber));
                                    calculator.setAddList();
                                } else if (operate=='/'){
                                    System.out.println("결과: " + calculator.divideOperator.setResult(fristnumber,secondnumber));
                                    calculator.setAddList();
                                } else if(operate=='%'){
                                    System.out.println("결과: " + calculator.modOperator.setResult(fristnumber,secondnumber));
                                    calculator.setAddList();
                                }
